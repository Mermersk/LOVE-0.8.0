-- Heli leikur, test me cameru og rekstra.
...
function love.load()
	...
	com = love.audio.newSource("com.ogg")
...
function love.update(dt)
	...
	r, g, b, a = mapData:getPixel(heli_x, heli_y)
	if r < 220 or g < 220 or b < 220 then
	    heli = crash
		love.audio.play(boom)
		paused = true
	end
	r, g, b, a = mapData:getPixel(heli_x + 19, heli_y + 19)
	if r < 220 or g < 220 or b < 220 then
	    heli = crash
		love.audio.play(boom)
	    paused = true
	end
	r, g, b, a = mapData:getPixel(heli_x + 19, heli_y)
	if r < 220 or g < 220 or b < 220 then
	    heli = crash
		love.audio.play(boom)
		paused = true
	end
	r, g, b, a = mapData:getPixel(heli_x, heli_y + 19)
	if r < 220 or g < 220 or b < 220 then
	    heli = crash
		love.audio.play(boom)
		paused = true
...
function love.draw()
    ...
    love.graphics.draw(map, 0, 0, 0, 1, 1)
