...
function love.load()
	...
	vopnbyrjun()
	vopntest = {vopn1, vopn2, vopn4, vopn5, vopn6, vopn7, vopn8, vopn9, vopn10, vopn11, vopn12, vopn13, vopn14, vopn15, vopn16, vopn17, vopn18, vopn19, vopn20, vopn21, vopn22}
    valid = "chosen area"
end
...
function vopnbyrjun()
	...
	for i = 1, 22 do
	    Enviroment['vopn' .. tostring(i)] = math.random(1, 2) == 1 and skjoldur or exi
	end
